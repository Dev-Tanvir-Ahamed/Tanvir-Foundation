...
const AboutUs = () => {
  ...
  return (
    <div className="sm:flex sm:gap-10 mt-10 max-w-7xl m-auto mb-10">
      ...
      <div className="about_us_content md:w-1/2 ml-3">
        ...
        <p className="mb-6 text-[18px]">
          It has been determined through research that when we feel compelled to
          help, and that someone authentically needs our assistance, and that no
          trick is being played on us, we reliably do intervene. Interestingly,
          it has been found that we are less likely to help when evaluating the
          intrinsic worth of assisting others, transcending cultural, religious,
